...
- **Review layers (E6 binding):** five concrete layers instantiate E6's four purposes — the pre-push layer runs twice, independently.
  ...
  5. **Static analysis** — SonarCloud on every PR and push to `main`. Purpose: the tireless linter backstop for defect classes agents overlook.
