...
- **(F1) The 45k-element console dump** in `GanttContainer.svelte`'s scroll-reset block — removed (it buried logs and froze DevTools). Never reinstate an all-elements `console.log`.
