...
- Full `npx jest` (bare): **175 suites / 3,794 tests, all passed** — including the new seam unit tests, the structural test, and the refitted registry/boundary/trend suites.
