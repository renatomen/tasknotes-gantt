...
- Dave Farley, *Modern Software Engineering: Doing What Works to Build Better Software Faster* (Addison-Wesley, 2021), via the maintainer’s *Modern Software Engineering* book notes; quotations are brief and for commentary, per `docs/conventions/documentation.md` § Quoting external works. Ch. 7 (Guided by Reality), Ch. 9 (The Importance of Testability; measurement points), Ch. 11 (Essential vs Accidental; Ports & Adapters), Ch. 12 (Fear of Over-Engineering; Isolate Third-Party Systems and Code), Ch. 14 (Measurement Points; Testing at the Edges).
