...
| Reliability-campaign PRs #439/#440/#441/#442 (2026-08-18/19) | 32095901273 (1), 32113805668 (2), 32127127689 (1), 32129856022 (1), 32131983798 (1), 32135340081 (1), 32177921660 (1), 32193605515 (1) | **9** | **1** | run 32113805668 attempt 1: `gantt-column-sort` AE1, error `not ready: Expected B before A on due-desc; saw A@0 B@-1` — the sort outcome never materialised and row B was absent (`B@-1`), a **different symptom** from the prior "did not become clickable" instances of the same spec |
