...
- **Patterns to follow:** defensive runtime resolution + event-refresh mechanics from [project/archived/TaskNotes Integration Architecture.md](project/archived/TaskNotes%20Integration%20Architecture.md) (mechanics only; API names from origin's confirmed surface).
- **Test scenarios:**
...
- Prior art (mechanics only, API names superseded by origin): [project/archived/TaskNotes Integration Architecture.md](project/archived/TaskNotes%20Integration%20Architecture.md); [docs/tasknotes-learnings.md](docs/tasknotes-learnings.md) (virtual-duplication model); [docs/KNOWN_ISSUES.md](docs/KNOWN_ISSUES.md) (SVAR CSP/font/listener quirks — expected, not bugs).
