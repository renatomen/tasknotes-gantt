...
- CSS zigzag-edge technique: [CSS Borders Using Masks](https://css-tricks.com/css-borders-using-masks/) (conic-gradient mask, repeat-y per edge). Chosen-treatment mock: [docs/mocks/missing-date-zigzag-options.html](../mocks/missing-date-zigzag-options.html).
