...
- **Test scenarios:**
  ...
  - Occurrence pieces on a swapped bar keep their per-state cues (dimming, hatching, outlines) layered above the diagonal — assert at least the blocked/dimmed and standard states.
