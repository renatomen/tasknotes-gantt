...
- **Test scenarios:**
  ...
  - Dependency link handles and link-delete controls on a masked bar remain visible and clickable — they sit outside the masked inner body layer (KTD2); exercise in the dependency e2e spec.
...
- **Test scenarios:**
  ...
  - Swapped task under Split rendering with indicators on keeps its pieces (ghost runs and occurrences unchanged) and the diagonal reads across them as one whole-bar half-fill per KTD4.
