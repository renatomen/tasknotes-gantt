...
grep -cE '^## (Bar color mode|Bar color source)' /tmp/og-appearance.md          # 0 once U1 landed
grep -cE '^## (Bar fill|Bar strip|Default legend position)' /tmp/og-appearance.md  # 3 once U1 landed
```
