...
- **Dependencies / environment:** dev-run config (fnm Node 20, `NODE_EXTRA_CA_CERTS=C:/Users/<you>/av-root-ca.pem`, `@swc/core-win32-x64-msvc` for jest, `OBSIDIAN_TEST_VAULT` for e2e); installed Svelte 5.39.6; the merged #73/#75/#77 behaviors are the revalidation targets.
