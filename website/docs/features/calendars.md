...
Calendar shading is drawn **around the view's tasks and
[calendar items](calendar-items.md)**, including rows you have hidden: from 62
days before the earliest to 62 days after the latest. A view with no tasks and
no calendar items shows no calendar shading and no markers, even for a calendar
you selected. The locale weekend is not limited this way.
