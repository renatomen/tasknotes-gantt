...
### Governance test
The recognition rule attached to a principle or practice: how to spot a violation without reading code. A principle without one is an aspiration; the test is what makes it reviewable, so every review layer checks against them.
