 ...
 * basis — TaskNotes stores `scheduled`/`due` as calendar dates. The single
 * date→frontmatter-string serialization, shared by the source's date writes,
 * the controller's property-patch resolution, and the view's stored-value
 * string forms.
 */
