...
export const LEGEND_CATALOGUE_ROWS = {
  ...
  'working-time-extension': ['calendar-pieces', { name: 'Working-time extension', meaning: 'The bar continues unchanged through non-working time because the estimate includes both working and non-working time.' }],
  ...
  'occurrence-occupancy': ['occurrence-pieces', { name: 'Occurrence occupancy', meaning: 'Separate painted pieces are occurrences of recurring tasks.' }],
