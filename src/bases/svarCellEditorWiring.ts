/**
 * Per-open wiring for the custom SVAR cell editors.
 *
 * Editor eligibility and row identity stay in the Svelte composition boundary.
 * This module only turns an already-resolved editor config into the concrete
 * runtime config mounted by SVAR.
 */
