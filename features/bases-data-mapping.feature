...
Feature: Bases Data Mapping
    ...
    @AUTOMATED @data-mapping @critical @bases-integration @imported-from-github
    ...
    @AUTOMATED @field-mappings @critical @bases-integration @imported-from-github
    ...
    @AUTOMATED @data-mapping @file-properties @bases-integration @imported-from-github
    ...
    @AUTOMATED @data-mapping @hierarchical-tasks @bases-integration @imported-from-github
    ...
    @AUTOMATED @property-flattening @data-mapping @bases-integration @imported-from-github
    ...
    @AUTOMATED @data-mapping @bases-integration @missing-data-handling @imported-from-github
    ...
    @AUTOMATED @data-mapping @real-time-sync @bases-integration @imported-from-github
    ...
    @AUTOMATED @configuration-validation @data-mapping @bases-integration @imported-from-github
