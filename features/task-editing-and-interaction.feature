...
Feature: Task Editing and Interaction
    ...
    @AUTOMATED @task-selection @critical @task-editing @imported-from-github
    ...
    @AUTOMATED @double-click-editing @critical @task-editing @imported-from-github
    ...
    @AUTOMATED @date-editing @drag-resize @task-editing @imported-from-github
    ...
    @AUTOMATED @date-validation @task-editing @validation @imported-from-github
    ...
    @AUTOMATED @task-editing @collaborative-editing @real-time-sync @imported-from-github
