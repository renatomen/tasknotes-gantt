...
Feature: Responsive Design and Mobile Support
    ...
    @AUTOMATED @mobile @responsive-design @touch-interaction @imported-from-github
    ...
    @AUTOMATED @layout @responsive-design @tablet-screens @imported-from-github
    ...
    @AUTOMATED @layout @responsive-design @desktop-screens @imported-from-github
    ...
    @AUTOMATED @responsive-design @timeline @scale-adaptation @imported-from-github
    ...
    @AUTOMATED @performance @responsive-design @mobile-performance @imported-from-github
    ...
    @AUTOMATED @orientation-changes @responsive-design @orientation @imported-from-github
