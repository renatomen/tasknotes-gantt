...
Feature: Bases View Registration and Integration
    ...
    @AUTOMATED @plugin-loading @bases-integration @bases-unavailable @imported-from-github
    ...
    @AUTOMATED @bases-integration @query-integration @data-flow @imported-from-github
    ...
    @AUTOMATED @configuration @view-config @bases-integration @imported-from-github
    ...
    @AUTOMATED @bases-integration @configuration-errors @error-handling @imported-from-github
