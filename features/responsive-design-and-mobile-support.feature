...
Feature: Responsive Design and Mobile Support
    ...
    @AUTOMATED @mobile @touch-interaction @responsive-design @imported-from-github
    ...
    @AUTOMATED @small-screens @layout @responsive-design @imported-from-github
    ...
    @AUTOMATED @tablet-screens @layout @responsive-design @imported-from-github
    ...
    @AUTOMATED @desktop-screens @layout @responsive-design @imported-from-github
    ...
    @AUTOMATED @adaptive-columns @columns @responsive-design @imported-from-github
    ...
    @AUTOMATED @timeline @scale-adaptation @responsive-design @imported-from-github
    ...
    @AUTOMATED @mobile-navigation @navigation @responsive-design @imported-from-github
    ...
    @AUTOMATED @performance @mobile-performance @responsive-design @imported-from-github
    ...
    @AUTOMATED @orientation-changes @orientation @responsive-design @imported-from-github
    ...
    @AUTOMATED @accessibility @touch-targets @responsive-design @imported-from-github
    ...
    @AUTOMATED @text-scaling @text @responsive-design @imported-from-github
    ...
    @AUTOMATED @dark-mode @theme-adaptation @responsive-design @imported-from-github
