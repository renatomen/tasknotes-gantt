...
Feature: Responsive Design and Mobile Support
    ...
    @AUTOMATED @layout @responsive-design @small-screens @imported-from-github
    ...
    @AUTOMATED @layout @desktop-screens @responsive-design @imported-from-github
    ...
    @AUTOMATED @columns @responsive-design @adaptive-columns @imported-from-github
    ...
    @AUTOMATED @mobile-navigation @responsive-design @navigation @imported-from-github
    ...
    @AUTOMATED @responsive-design @orientation @orientation-changes @imported-from-github
    ...
    @AUTOMATED @responsive-design @touch-targets @accessibility @imported-from-github
    ...
    @AUTOMATED @text @responsive-design @text-scaling @imported-from-github
    ...
    @AUTOMATED @theme-adaptation @responsive-design @dark-mode @imported-from-github
