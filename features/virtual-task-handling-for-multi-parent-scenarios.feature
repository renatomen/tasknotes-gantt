...
Feature: Virtual Task Handling for Multi-Parent Scenarios
    ...
    @AUTOMATED @critical @task-management @multi-parent @virtual-tasks @imported-from-github
    ...
    @AUTOMATED @task-management @unique-ids @virtual-tasks @imported-from-github
    ...
    @AUTOMATED @task-management @data-consistency @virtual-tasks @imported-from-github
    ...
    @AUTOMATED @single-parent-fallback @task-management @virtual-tasks @imported-from-github
    ...
    @AUTOMATED @task-management @no-parent-handling @virtual-tasks @imported-from-github
    ...
    @AUTOMATED @empty-parents-array @task-management @virtual-tasks @imported-from-github
    ...
    @AUTOMATED @mixed-parent-types @task-management @virtual-tasks @imported-from-github
    ...
    @AUTOMATED @task-management @virtual-tasks @performance @imported-from-github
    ...
    @AUTOMATED @task-management @data-integrity @virtual-tasks @imported-from-github
    ...
    @AUTOMATED @task-management @virtual-tasks @hierarchy-display @imported-from-github
