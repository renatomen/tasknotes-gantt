...
Feature: Virtual Task Handling for Multi-Parent Scenarios
    ...
    @AUTOMATED @multi-parent @virtual-tasks @critical @task-management @imported-from-github
    ...
    @AUTOMATED @virtual-tasks @data-consistency @task-management @imported-from-github
    ...
    @AUTOMATED @virtual-tasks @single-parent-fallback @task-management @imported-from-github
    ...
    @AUTOMATED @virtual-tasks @no-parent-handling @task-management @imported-from-github
    ...
    @AUTOMATED @virtual-tasks @empty-parents-array @task-management @imported-from-github
    ...
    @AUTOMATED @virtual-tasks @mixed-parent-types @task-management @imported-from-github
    ...
    @AUTOMATED @virtual-tasks @performance @task-management @imported-from-github
    ...
    @AUTOMATED @virtual-tasks @hierarchy-display @task-management @imported-from-github
