...
Feature: Task Rendering in Gantt Chart
    ...
    @AUTOMATED @critical @gantt-visualization @smoke @imported-from-github
    ...
    @AUTOMATED @data-mapping @critical @gantt-visualization @imported-from-github
    ...
    @AUTOMATED @data-mapping @gantt-visualization @imported-from-github
    ...
    @AUTOMATED @progress @gantt-visualization @imported-from-github
    ...
    @AUTOMATED @empty-state @gantt-visualization @imported-from-github
    ...
    @AUTOMATED @error-handling @gantt-visualization @imported-from-github
