...
Feature: Bases View Registration and Integration
    ...
    @AUTOMATED @bases-integration @bases-unavailable @plugin-loading @imported-from-github
    ...
    @AUTOMATED @mounting @bases-integration @view-lifecycle @imported-from-github
    ...
    @AUTOMATED @bases-integration @view-config @configuration @imported-from-github
    ...
    @AUTOMATED @plugin-unload @cleanup @bases-integration @imported-from-github
