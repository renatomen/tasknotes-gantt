...
Feature: Bases View Registration and Integration
    ...
    @AUTOMATED @plugin-loading @critical @bases-integration @imported-from-github
    ...
    @AUTOMATED @plugin-loading @bases-integration @api-version-check @imported-from-github
    ...
    @AUTOMATED @plugin-loading @bases-unavailable @bases-integration @imported-from-github
    ...
    @AUTOMATED @container-creation @bases-integration @view-factory @imported-from-github
    ...
    @AUTOMATED @view-lifecycle @mounting @bases-integration @imported-from-github
    ...
    @AUTOMATED @view-config @configuration @bases-integration @imported-from-github
    ...
    @AUTOMATED @configuration-errors @error-handling @bases-integration @imported-from-github
    ...
    @AUTOMATED @data-updates @reactive-updates @bases-integration @imported-from-github
    ...
    @AUTOMATED @cleanup @bases-integration @plugin-unload @imported-from-github
