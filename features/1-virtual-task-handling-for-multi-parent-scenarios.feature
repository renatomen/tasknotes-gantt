...
Feature: Virtual Task Handling for Multi-Parent Scenarios
    ...
    @AUTOMATED @task-management @virtual-tasks @multi-parent @critical @imported-from-github
    ...
    @AUTOMATED @task-management @virtual-tasks @unique-ids @imported-from-github
    ...
    @AUTOMATED @data-consistency @task-management @virtual-tasks @imported-from-github
    ...
    @AUTOMATED @task-management @virtual-tasks @single-parent-fallback @imported-from-github
    ...
    @AUTOMATED @task-management @virtual-tasks @no-parent-handling @imported-from-github
    ...
    @AUTOMATED @task-management @virtual-tasks @empty-parents-array @imported-from-github
    ...
    @AUTOMATED @task-management @virtual-tasks @mixed-parent-types @imported-from-github
    ...
    @AUTOMATED @data-integrity @task-management @virtual-tasks @imported-from-github
