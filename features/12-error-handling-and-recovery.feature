...
Feature: Error Handling and Recovery
    ...
    @AUTOMATED @critical @configuration-errors @error-handling @imported-from-github
    ...
    @AUTOMATED @data-loading @missing-data @error-handling @imported-from-github
    ...
    @AUTOMATED @error-handling @bases-unavailable @plugin-dependencies @imported-from-github
    ...
    @AUTOMATED @version-mismatch @api-compatibility @error-handling @imported-from-github
    ...
    @AUTOMATED @error-handling @user-feedback @error-reporting @imported-from-github
    ...
    @AUTOMATED @graceful-degradation @partial-functionality @error-handling @imported-from-github
