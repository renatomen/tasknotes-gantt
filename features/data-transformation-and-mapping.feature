...
Feature: Data Transformation and Mapping
    ...
    @AUTOMATED @data-transformation @missing-data @date-inference @imported-from-github
    ...
    @AUTOMATED @inverted-ranges @data-transformation @date-validation @imported-from-github
    ...
    @AUTOMATED @data-transformation @property-preservation @imported-from-github
    ...
    @AUTOMATED @data-transformation @progress-normalization @imported-from-github
    ...
    @AUTOMATED @data-transformation @config-validation @validation @imported-from-github
    ...
    @AUTOMATED @large-datasets @data-transformation @performance @imported-from-github
